...
public class DocumentDeliveryOptions {

    public DocumentDeliveryOptions(){}

    public DocumentDeliveryOptions(Long id){
        this.id = id;
    }

    public DocumentDeliveryOptions(Object id, Object description, Object flagReason) {
    ...
    public DocumentDeliveryOptions id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public DocumentDeliveryOptions description(String description) {
    ...
    public DocumentDeliveryOptions flagReason(Boolean flagReason) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, documentDeliveryOptions.id);
    }
